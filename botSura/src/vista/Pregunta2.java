...
public class Pregunta2 extends javax.swing.JFrame {
  ...
  public static int gato=0;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("A. Retiro, Cesant�a en eda avanzada y vejez.");

        jLabel3.setText("C. Sociedades de Inversi�n Especializadas en");

        jLabel4.setText("B. Unidad de Medida y Actualizaci�n.");

        jLabel5.setText("Fondos para el Retiro.");

        jLabel6.setText("Registra las aportaciones bimestrales de car�cter obligatorio que ");

        jLabel7.setText("deben efectuar elpatr�n, el trabajador y el Gobierno Federal: ");
